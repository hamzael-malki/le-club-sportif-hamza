    ...
    <!-- index.html  21 Decem 2022  -->
    <head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
    <title>@yield('pagetitle') - Le Club Sportif</title>
    ...
    <link rel='shortcut icon' type='image/x-icon' href="{{ asset('dashboard_asset/assets/css/custom.css') }}" />
    </head>
    ...
    <div id="app">
        ...
        <div class="main-sidebar sidebar-style-2">
            ...
            <div class="sidebar-brand">
                <a href="/dashboard"> <img alt="image" src="{{ asset('dashboard_asset/assets/img/logo.png') }}" class="header-logo" /> <span
                    class="logo-name">L.C.S</span>
                </a>
            </div>
            <ul class="sidebar-menu">
                <li class="menu-header">Main</li>
                <li class="dropdown active">
                <a href="{{route('admin.dashboard')}}" class="nav-link"><i data-feather="monitor"></i><span>Vue Admin</span></a>
                </li>
                <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                    data-feather="briefcase"></i><span>Réservations</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{route('admin.allcategory')}}">Tous les réservations</a></li>
                    <li><a class="nav-link" href="{{route('admin.createcategory')}}">Réservations en attente</a></li>
                    <li><a class="nav-link" href="widget-data.html">Réservations complètes</a></li>
                </ul>
                </li>
                ...
                <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                    data-feather="briefcase"></i><span>Coachs</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{route('admin.allsubcategory')}}">Tous les coachs</a></li>
                    <li><a class="nav-link" href="{{route('admin.createsubcategory')}}">??????????</a></li>
                ...
                <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                    data-feather="briefcase"></i><span>Membres</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="widget-chart.html">Tous les membres</a></li>
                    <li><a class="nav-link" href="widget-data.html">Membres</a></li>
                    <li><a class="nav-link" href="widget-data.html">??????????</a></li>
                </ul>
                </li>
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{route('admin.message')}}">Voir les messages</a></li>
                    <li><a class="nav-link" href="email-compose.html">???????</a></li>
                    <li><a class="nav-link" href="email-read.html">???????</a></li>
                </ul>
                </li>
